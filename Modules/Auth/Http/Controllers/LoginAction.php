...
class LoginAction extends Controller
{
  public function __invoke(AuthRequest $request)
  {
    ...
    $user = User::with(['roles:id,name', 'roles.permissions:id,name', 'permissions:id,name', 'media'])->select('id', 'email', 'username', 'password', 'is_active')->where($field, $username)->first();
    ...
    if (!$user->is_active) return $this->error(['message' => trans('auth::auth.account_not_active')], Response::HTTP_UNAUTHORIZED);
